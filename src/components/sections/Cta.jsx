...
const Cta = () => {
  ...
  useGSAP(() => {
    const parallaxTimeline = gsap.timeline({repeat : -1, yoyo : true,
      scrollTrigger: {
        trigger: ctaSectionRef.current,
       	start: 'top 100%',
		    end: 'bottom top',   
