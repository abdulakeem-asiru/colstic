...
const Testimonial = () => {
  ...
  return (
    <section id='testimonial'   ref={sectionRef} className="w-full flex flex-col items-center justify-around text-white bg-gradient-to-b from-[#101010] to-[#2B2B2B] mt-16 mb-0 overflow-x-hidden">
